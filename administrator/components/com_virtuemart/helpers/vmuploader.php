		...
		switch ($media['error']) {
			...
			*/
				...
				if(vmAccess::manager('core')){
					VmInfo(vmText::sprintf('COM_VIRTUEMART_FILE_UPLOAD_OK',$uploadPath));
				} else {
					VmInfo(vmText::sprintf('COM_VIRTUEMART_FILE_UPLOAD_OK',$media['name']));
				}
