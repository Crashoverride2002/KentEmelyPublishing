...
/**
 *
 * Controller for the front end Creditnota
 *
 * @package	VirtueMart
 * @subpackage User
 * @author Kent Hansen
 * @copyright Copyright (c) 2024 - 2035. All rights reserved.
 ...
 * @package		VirtueMart
 */
class VirtueMartControllerCreditnota extends JControllerLegacy
{
	var $useSSL = null;
	var $useXHTML = false;
	var $unlockInvoice = 0;
